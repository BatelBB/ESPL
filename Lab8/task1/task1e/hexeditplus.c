...
void memoryDisplay(state *s) 
{
    ...
    print_units(stdout, start, u, s->display_mode, s->unit_size);        
...
void saveIntoFile(state *s) 
{
    ...
    printf("%x %x %d", source_address, target_location, length);
    ...
    {
        fwrite((char *)source_address , s->unit_size, length, file);
    }
